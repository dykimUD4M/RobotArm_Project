...
namespace MegaFiers
{
	[CustomEditor(typeof(MegaWalkLoftSmooth))]
	public class MegaWalkLoftSmoothEditor : Editor
	{
		private     MegaWalkLoftSmooth	src;
		private     MegaUndo		undoManager;

		private void OnEnable()
		{
			src = target as MegaWalkLoftSmooth;
		...
		{
			MegaWalkLoftSmooth walk = (MegaWalkLoftSmooth)target;
			...
			walk.useRaycast = EditorGUILayout.Toggle("Use Raycast", walk.useRaycast);
