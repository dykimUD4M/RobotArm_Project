...
namespace MegaFiers
{
	[CustomEditor(typeof(MegaLoftLayerScatter))]
	public class MegaLoftLayerScatterEditor : MegaLoftLayerBaseEditor
	{
		private     MegaLoftLayerScatter	src;
		private     MegaUndo				undoManager;

		private void OnEnable()
		{
			src = target as MegaLoftLayerScatter;
