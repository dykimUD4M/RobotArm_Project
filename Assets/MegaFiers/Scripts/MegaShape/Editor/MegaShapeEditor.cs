...
namespace MegaFiers
{
	...
	public class MegaShapeEditor : Editor
	{
	...
	#if UNITY_5_5 || UNITY_5_6 || UNITY_2017_1_OR_NEWER	// || UNITY_2018 || UNITY_2019 || UNITY_2020 || UNITY_2021 || UNITY_2022 || UNITY_2023
	#else
		bool hidewire = false;
	#endif
	...
	#if UNITY_2017_2_OR_NEWER	// || UNITY_2017_3 || UNITY_2017_4 || UNITY_2018 || UNITY_2019 || UNITY_2020 || UNITY_2021 || UNITY_2022 || UNITY_2023
		...
		public override void OnInspectorGUI()
		{
			...
			if ( recalc )
			{
				...
				MegaLoftLayerSimple[] layers = (MegaLoftLayerSimple[])FindObjectsByType(typeof(MegaLoftLayerSimple), FindObjectsSortMode.None);
#else
	 ...
	 // call this function in OnGUI before calling TextField (only needs to be called once)
	...
	#if UNITY_2017 || UNITY_2018 || UNITY_2019 || UNITY_2020 || UNITY_2021 || UNITY_2022 || UNITY_2023
		...
		[MenuItem("GameObject/Bake MegaShape to Prefab")]
		static void DoShapeBake()
		{
			if ( Selection.activeGameObject != null )
			{
				...
				GameObject baked = BakeShapeToMeshPrefab(obj);
			}
		}

		static public GameObject BakeShapeToMeshPrefab(GameObject root)
		{
			...
			MegaShapeLoft[] lofts = newobj.GetComponents<MegaShapeLoft>();

			for ( int i = 0; i < lofts.Length; i++ )
			{
				Mesh mesh = lofts[i].mesh;

				string mname = lofts[i].name;
			...
			lofts = prefab.GetComponents<MegaShapeLoft>();

			for ( int i = 0; i < lofts.Length; i++ )
			{
				MegaLoftLayerBase[] layers = lofts[i].GetComponents<MegaLoftLayerBase>();

				for ( int j = 0; j < layers.Length; j++ )
				{
					DestroyImmediate(layers[j], true);
					layers[j] = null;
				}

				//lofts[i].restorekeep = 1;
				DestroyImmediate(lofts[i], true);
			}
	...
	#if UNITY_2019 || UNITY_2018_3_OR_NEWER	// || UNITY_2020 || UNITY_2021 || UNITY_2022 || UNITY_2023
	...
	#if UNITY_5_0 || UNITY_5_1 || UNITY_5_2 || UNITY_5 || UNITY_2017_1_OR_NEWER	// || UNITY_2018 || UNITY_2019 || UNITY_2020
