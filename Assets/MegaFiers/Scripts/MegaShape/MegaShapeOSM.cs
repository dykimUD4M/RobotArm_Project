...
namespace MegaFiers
{
	...
	public class MegaShapeOSM
	{
		...
		public void ParseXML(MegaShapeXMLNode node)
		{
		...
		public void ParseOSM(MegaShapeXMLNode node)
		{
			foreach ( MegaShapeXMLNode n in node.children )
			{
				switch ( n.tagName )
		...
		public void ParseNode(MegaShapeXMLNode node)
		{
		...
		public void ParseWay(MegaShapeXMLNode node)
		{
		...
		public void ParseND(MegaShapeXMLNode node, MegaShapeOSMWay way)
		{
			for ( int i = 0; i < node.values.Count; i++ )
			{
				MegaShapeXMLValue val = node.values[i];
		...
		public void ParseTag(MegaShapeXMLNode node, MegaShapeOSMWay way)
		{
