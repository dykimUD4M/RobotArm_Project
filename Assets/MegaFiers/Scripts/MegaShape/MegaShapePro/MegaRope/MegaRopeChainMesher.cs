...
namespace MegaFiers
{
	...
	public class MegaRopeChainMesher : MegaRopeMesher
	{
		...
		public override void BuildMesh(MegaRope rope)
		{
			...
			MegaShapeMatrix.RotateY(ref linkrot2, Mathf.PI * 0.5f);

			MegaShapeMatrix.RotateY(ref linkrot1, Mathf.PI * 0.5f);
			MegaShapeMatrix.RotateZ(ref linkrot1, Mathf.PI * 0.5f);

			MegaShapeMatrix.Scale(ref linkrot1, linkScale, false);
			MegaShapeMatrix.Scale(ref linkrot2, linkScale, false);
			...
			if ( linkcount > rope.gameObject.transform.childCount )
			{
				...
				for ( int i = index; i < linkcount; i++ )
				{
					...
					if ( obj )
					{
						...
						Mesh ms = MegaShapeHelper.GetSharedMesh(obj);
	...
	#if UNITY_5_4 || UNITY_5_5 || UNITY_5_6 || UNITY_2017_1_OR_NEWER	// || UNITY_2018 || UNITY_2019 || UNITY_2020 || UNITY_2021 || UNITY_2022 || UNITY_2023
