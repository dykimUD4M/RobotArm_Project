	...
	public class MegaHose : MonoBehaviour
	{
		...
		void BuildMesh()
		{
			...
			else
			{
				...
				mat1NT = mat1;
				mat2NT = mat2;
				MegaShapeMatrix.NoTrans(ref mat1NT);
				MegaShapeMatrix.NoTrans(ref mat2NT);
				...
				Matrix4x4 T1 = mat1;
				MegaShapeMatrix.NoTrans(ref T1);
				...
				MegaShapeMatrix.NoTrans(ref SI);
				...
				MegaShapeMatrix.SetTrans(ref Tlocal, P0);

				// move z-axes of end transforms into local frame
				Matrix4x4 TlocalInvNT = Tlocal;
				MegaShapeMatrix.NoTrans(ref TlocalInvNT);
			...
			for ( int i = 0; i < maxseg; i++ )
			{
				...
				MegaShapeMatrix.SetTrans(ref RingTM, ThisPosition);
				...
				{
					invRingTM = RingTM;
					MegaShapeMatrix.NoTrans(ref invRingTM);
