...
namespace MegaFiers
{
	public class MegaShapeXMLValue
	{
		public string	name;
		public string	value;
	}

	public class MegaShapeXMLNode
	{
		public String                           tagName;
		public MegaShapeXMLNode                      parentNode;
		public List<MegaShapeXMLNode>                children;
		public List<MegaShapeXMLValue>				values;

		public MegaShapeXMLNode()
		{
			tagName = "NONE";
			parentNode = null;
			children = new List<MegaShapeXMLNode>();
			values = new List<MegaShapeXMLValue>();
		}
	}

	public class MegaShapeXMLReader
	{
		...
		public MegaShapeXMLReader()
		{
		}

		public MegaShapeXMLNode read(String xml)
		{
			int index = 0;
			int lastIndex = 0;
			MegaShapeXMLNode rootNode = new MegaShapeXMLNode();
			MegaShapeXMLNode currentNode = rootNode;
			...
			while ( true )
			{
				...
				MegaShapeXMLNode node = parseTag(xmlTag);
		...
		public MegaShapeXMLNode parseTag(String xmlTag)
		{
			MegaShapeXMLNode node = new MegaShapeXMLNode();
		...
		public MegaShapeXMLNode parseAttributes(String xmlTag, MegaShapeXMLNode node)
		{
			int index = 0;
			int attrNameIndex = 0;
			int lastIndex = 0;
			...
			while ( true )
			{
				...
				MegaShapeXMLValue val = new MegaShapeXMLValue();
				val.name = attrName;
				val.value = attrValue;
				node.values.Add(val);
			}
