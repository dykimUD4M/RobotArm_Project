...
namespace MegaFiers
{
	...
	public class MegaShapeSVG
	{
		public void LoadXML(string svgdata, MegaShape shape, bool clear, int start)
		{
			...
			MegaShapeXMLNode node = xml.read(svgdata);
		...
		void ParseCircle(MegaShapeXMLNode node, MegaShape shape)
		{
		...
		void ParseEllipse(MegaShapeXMLNode node, MegaShape shape)
		{
			MegaSpline spline = GetSpline(shape);
		...
		void ParseRect(MegaShapeXMLNode node, MegaShape shape)
		{
			MegaSpline spline = GetSpline(shape);
		...
		void ParsePolygon(MegaShapeXMLNode node, MegaShape shape)
		{
			MegaSpline spline = GetSpline(shape);
		...
		void ParsePath(MegaShapeXMLNode node, MegaShape shape)
		{
