...
****************************************
v2.54
Added option to the GameObject menu to bake a MegaShapes Loft to a simple Gameobject prefab.

v2.53
MegaShapes fully compatible with Unity 6

v2.52
Added a Terrain Carve demo scene for the race track that shows it in use.

v2.51
Added missing ContainsSubDiv method to MegaShape which is used by MegaScatter

v2.50
New version of the RBody path follow script which allows for lateral movement while following a spline.

v2.49
Fixed a bug which stopped spline knots from being moved that was introduced in v2.48

v2.48
Fix for missing function errors in 2021.3

v2.47
Fixed obsolete warnings when using Unity 2022.2
Removed stray Debug.log
Fixed a small error in the loft layer simple and loft layer multimap when using cross sectionscale curves, the last cross section gets scaled by the start of the curve.

v2.46
Added back in missing pot from Pottery demo scene
Added extra checks to loft layers for zero length splines.

v2.45
Fixed errors in Unity 2022.1 regarding FindObjects missing method.

v2.44
MegaShapes made fully compatible with Unity 2023

v2.43
All scripts are now in the 'MegaFiers' namespace, this might be code breaking so please backup any projects before updating.
Fixed dup script errors when installing MegaFiers 2 and MegaShapes in the same project
Fixed demo scenes that had lost their mesh/object references due to Unity version updater losing them

v2.42
MegaUtils.cs renamed to MegaShapeHelper.cs to avoid name comflicts when installed alongside MegaFiers 2
MegaMatrix.cs renamed to MegaShapeMatrix.cs to avoid name comflicts when installed alongside MegaFiers 2
MegaBox3.cs renamed to MegaShapeBox3.cs to avoid name comflicts when installed alongside MegaFiers 2
MegaXMLReader.cs renamed to MegaShapeXMLReader.cs to avoid name comflicts when installed alongside MegaFiers 2

v2.41
Fixed some issues in the Spline Auto Smooth system where expecially on open splines the end point handles could be wrong.
MegaShapes made fully compatible with Unity 2022

v2.40
Fixed the GUILayer not used any more in the demo scenes.
Adjusted a couple of demo scenes where some references were missing after scene conversion.

v2.39
MegaShapes made fully compatible with Unity 2021
